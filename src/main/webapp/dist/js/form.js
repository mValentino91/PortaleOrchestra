...
function addor(contid, tasto) {
    ...
    newstart.className = "form-control orarilav obb";
    ...
    newstartm.className = "form-control orarilav obb";
...
function checkobb() {
    ...
    var short = $('.shortd')[0];
    if (short != undefined && short.value.trim() == '')
        ok = false;
    var par = $(".par");
