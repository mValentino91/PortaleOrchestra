...
<html>
    ...
    <body>
        ...
        <div class="col-md-12" style="background-color: #0081c2; color:#FFFFFF; text-align: center; margin-bottom:20px;">
            <h1><b>Inserimento di un nuovo poi</b></h1><br>
                ...
                <div class="col-md-6" id="inglese">
                    ...
                    <div class="row">
                        ...
                        <div class="details">
                            <center>
                                <div id="enorari">
                                    <input type="button" id="nuovogiorno" class="btn btn-success" value="Inserisci un  periodo lavorativo" onclick="enaddwd(this)"><br><br>
                                    <input type="button" class="btn btn-success" value="Aggiungi un giorno di riposo" onclick="enaddripann(this)"><br>
                                </div>
                            </center>
                        </div>
                    </article>
