...
<html>
    ...
    <center>
        ...
        <form action="deletepoi"  accept-charset="UTF-8">
            Digita il nome del Poi <input type="text" id="autocomplete" style="width: 300px; margin-bottom: 5px; margin-left: 30px;" class="form-control" name="name"> <input class="btn btn-danger" type="submit" value="ELIMINA">
        </form>       
