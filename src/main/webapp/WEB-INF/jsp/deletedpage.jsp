<%-- 
    ...
    Created on : 22-apr-2015, 11.43.46
    Author     : Alex
--%>
...
<center>
    <article class="component component-text" style="margin-top:50px; width: 400px;">
        <div class="big-header" style="background-color: #d9534f;" >
            <span class="caps">Elimina una pagina d'approfondimento</span>
        </div> 
        <div class="details" style="text-align: center;">
            <form action="deldpage"  accept-charset="UTF-8">
                Digita il nome della pagina d'approfondimento <input type="text" id="autocomplete" style="width: 300px; margin-bottom: 5px; margin-left: 30px;" class="form-control" name="name"> <input class="btn btn-danger" type="submit" value="ELIMINA">
            </form>       
            <h2 style="margin-top: 25px;">Oppure</h2>
            <form action="deldpage">
                Digita l'id della pagina d'approfondimento <input type="text" style="width: 300px; margin-bottom: 5px; margin-left: 30px;" class="form-control" name="id"> <input class="btn btn-danger" type="submit" value="ELIMINA">
            </form> 
        </div>
    </article>
