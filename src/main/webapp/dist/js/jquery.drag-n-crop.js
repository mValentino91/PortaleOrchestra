...
;(function ( $, window, document, undefined ) {
    ...
    $.widget( "lukaszfiszer.dragncrop" , {
        ...
        options: {
          ...
          // Drag instruction
          instruction: false,
          instructionText: 'Trascina per posizionare',
          instructionHideOnHover: false,
        },
        ...
        _insertInstruction: function() {
          this.instruction = $('<div id="istr">').addClass(this.classes.instruction);
