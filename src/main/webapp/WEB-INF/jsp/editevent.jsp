...
<html>
    ...
    <center>
        ...
        <form action="editevent"  accept-charset="UTF-8">
            Digita il nome dell'evento <input type="text" style="width: 300px; margin-bottom: 5px; margin-left: 30px;" class="form-control" name="name"> <input class="btn btn-warning" type="submit" value="MODIFICA">
        </form> 
