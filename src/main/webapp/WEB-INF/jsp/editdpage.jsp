<%-- 
    Document   : editdpage
    Created on : 21-apr-2015, 11.51.10
    Author     : Alex
--%>
    ...
    <center>
        <article class="component component-text" style="margin-top:50px; width: 400px;">
            <div class="big-header " style="background-color: #f0ad4e;">
                <span class="caps">Modifica una pagina d'approfondimento</span>
            </div> 
            <div class="details" style="text-align: center;">
                <form action="editdpage"  accept-charset="UTF-8">
                    Digita il nome della pagina d'approfondimento <input type="text" id="autocomplete" style="width: 300px; margin-bottom: 5px; margin-left: 30px;" class="form-control" name="name"> <input class="btn btn-warning" type="submit" value="MODIFICA">
                </form> 
                <h2 style="margin-top:25px;">Oppure</h2>
                <form action="editdpage">
                    Digita l'id della pagina d'approfondimento <input type="text" style="width: 300px; margin-bottom: 5px; margin-left: 30px;" class="form-control" name="id"> <input class="btn btn-warning" type="submit" value="MODIFICA">
                </form>  
            </div>
        </article>
...
<script>
    $('#autocomplete').autocomplete({
        serviceUrl: '../Search/Autocompletedpage',
        onSelect: function (suggestion) {
            window.location = './editdpage?id=' + suggestion.data;
        }
    });
</script>
</html>
