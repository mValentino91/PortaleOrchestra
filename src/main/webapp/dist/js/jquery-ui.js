...
function Datepicker() {
	...
	this.regional[""] = { // Default regional settings
		...
		prevText: "Mese precedente", // Display text for previous month link
		nextText: "Prossimo mese", // Display text for next month link
		...
		dayNamesShort: ["Dom", "Lun", "Ma", "Me", "Gio", "Ven", "Sab"], // For formatting
